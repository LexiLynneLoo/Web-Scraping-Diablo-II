...
This function reads an item, parses the values from its description, and creates a dataframe entry to be added to the larger dataframe.
...
def parseD2item(item,df):
    ...
    referenceDict.update({
        ...
        r'\+(\d+) poison damage over 3 seconds':"Psn3",
        r'\+(\d+) poison damage over 4 seconds':"Psn4",
        r'\+(\d+) poison damage over 5 seconds':"Psn5",
        r'\+(\d+) poison damage over 6 seconds':"Psn6",
        r'\+(\d+) poison damage over 7 seconds':"Psn7",
        r'\+(\d+) poison damage over 8 seconds':"Psn8",
